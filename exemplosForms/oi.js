...
console.log("Pedro\t10\t2A")
console.log("Maria\t8\t2B")
console.log("Anastacio\t8,5\t2C")

let nome = "Pedro"
console.log("Oi meu amigo"+nome.toUpperCase())
...
console.log("A soma desses números é"+numero1+"mais"+numero2+"é"+(numero1+numero2))
